...
public class UI 
{
	...
	public void drawBattle()
	{
		...
		String valores;
                ...
                valores = "qualquer coisa";
                g2.drawString(valores,300,50);
	...
	public void drawGameOver()
	{
		...
		g2.setFont(g2.getFont().deriveFont(Font.PLAIN,25F));
                ...
                g2.drawString(textF, (gp.screenLargura/3)-45, 220);
                g2.drawString(textF2, (gp.screenLargura/3)-45, 250);
		
		/*g2.drawImage(gp.player.botaosair, 300, 270, gp.tileSize*4, gp.tileSize*2, null);
		if(comandoP == 0)
		{
			g2.drawString(">",210, 320);
		}*/
				
		g2.drawImage(gp.player.botaosair, 300, 400, gp.tileSize*4, gp.tileSize*2, null);
		if(comandoP == 1)
		{
			g2.drawString(">",210, 465);
		}		
	}
