...
public class LigiaNPC extends Entidade
{
	...
	public LigiaNPC(GamePainel gp)
	{
		...
		public void setDialogo()
		{
			...
			{
				dialogos[0] ="Ligia: Seja Bem-vindo à Fatec \n Cruzeiro! \nTemos os melhores cursos de \ngraduação da região...";
				dialogos[1] = "Ligia: Porem, recentes eventos \nvem dificultando a vida dos \nnossos alunos, precisamos de \n"
					+ "uma mente brilhante ";
				dialogos[2] = "Ligia: para passar por todos os \ndesafios e salvar a faculdade \ndo MASTER OF FLUKERS";
				dialogos[3] = "Ligia: Vá a biblioteca pois a Prof. \nEuridice tem mais pistas sobre o \ncaso.";
			}
			
			if(gp.player.level > 4)
			{
				dialogos[0] = "Ligia: Oh não, uma clausula \ncontratual me impede de dizer \no codigo de acesso da sala do \nMASTER OF FLUKERS";
				dialogos[1] = "Ligia: Mas saiba que na minha \nfamilia \"um único primo se \ndestaca entre todos\"";
				dialogos[2] = "Ligia: Oh não, uma clausula \ncontratual me impede de dizer \no codigo de acesso da sala do \nMASTER OF FLUKERS";
				dialogos[3] = "Ligia: Mas saiba que na minha \nfamilia \"um único primo se \ndestaca entre todos\"";
			}
		}
