...
public class GamePainel extends JPanel implements Runnable
{
	...
	// config do mapa
	public final int maxWorldColuna = 84;// quantidade de colunas que vao ser desenhadas
	public final int maxWorldLinha = 34; // quantidade de linhas que vao ser desenhadas
