...
public class Conexao 
{
    ...
    public void Salvar(GamePainel gp)
	{
		...
		try 
        {
		    ...
		    + "VALUES ('"+gp.player.level+"','"+gp.player.vida+"', '"+gp.player.moeda+"', '"+gp.player.worldY+"', '"+gp.player.worldX+"')";		  
