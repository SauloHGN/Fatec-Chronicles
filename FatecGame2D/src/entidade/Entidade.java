...
//Tela Menu
public BufferedImage telainicio, botaojogar, botaoopc, botaosair, botaoCarregar, menufundo, ET, win;
...
// batalha
public BufferedImage batalhaFundo, botaoLv, botaoPontos, botaoBatalha, Arena,  cerebro, fundo;
...
public void fala()
{
	...
	if(dialogos[setDialogo][dialogoCont] == dialogos[0][4] && gp.player.level == 4)
	{
