...
public class ChNPC extends Entidade
{
	...
	public ChNPC(GamePainel gp)
	{
		...
		public void setDialogo()
		{
			...
			{
				dialogos[0] = "Charles: Estou ocupado agora,\nvolte mais tarde...";
			}
			
			
			if(gp.player.level > 4)
			{
				dialogos[0] ="Charles: Caraca, só posso \ndivulgar a senha depois de \nassistir a terceira temporada \nde Cavalheiro da Lua!";
				dialogos[1] = "Charles: Até lá, a relatividade do \ninfinito, nos mostra o quão \npequeno ele pode ser.\n";
				dialogos[2] = "A faculdade nem sempre está com \nas portas abertas.";
			}
		}
